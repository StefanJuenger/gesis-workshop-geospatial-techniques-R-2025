...
:::: columns
::: {.column width="50%"}
![](../img/random.png){fig-align="center" width="50%"}
:::

::: {.column width="50%"}
![](../img/non_random.png){fig-align="center" width="50%"}
...
:::: columns
::: {.column width="50%"}
![](../img/rook.png){fig-align="center" width="50%"}
:::

::: {.column width="50%"}
![](../img/queen.png){fig-align="center" width="50%"}
:::
::::
...
:::: columns
::: {.column width="50%"}
![](../img/rook_interdependent.png){fig-align="center" width="50%"}
:::
...
[Exercise](https://stefanjuenger.github.io/gesis-workshop-geospatial-techniques-R-2024/exercises/7_Neighborhood_Matrices.html)

[Solution](https://stefanjuenger.github.io/gesis-workshop-geospatial-techniques-R-2024/solutions/7_Neighborhood_Matrices.html)
