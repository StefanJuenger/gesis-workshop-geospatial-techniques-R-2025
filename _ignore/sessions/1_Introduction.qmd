...
::: {.column width="60%"}
- Postdoctoal Researcher in the team Survey Data Augmentation at the GESIS department Survey Data Curation
- Ph.D. in social sciences, University of Cologne
- Research interests:
  - Quantitative methods, Geographic Information Systems (GIS)
  - Social inequalities
...
![](../img/park_etal.png){fig-align="center" width="50%"}
...
<p align = "right"><small>Xu, 2023</small></p>
:::
:::::
...
<p align = "center"><small>[Source](http://geotiff.maptools.org/proj_list/guid7.html)</small></p>
:::
::::
...
<p align = "center"><small>[Source](https://dx.doi.org/10.13140/2.1.3030.1767)</small></p>

## Packages in this course I 

We will use plenty of different packages during the course, but only a few are our main drivers (e.g., the `sf` package). Here's the list of packages you at least need for the exercises:
