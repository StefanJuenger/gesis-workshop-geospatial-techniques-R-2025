...
Choose a color of your choice for both maps.
```
...
In the second step, we want to visualize some information on the German districts contained in the attribute table.
Choose a column of interest and create a map.
